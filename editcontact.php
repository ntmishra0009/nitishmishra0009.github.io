...
if (isset($_POST['update'])) {
    ...
    if($_FILES['myFile']['size']!=0)
    {
        ...
        $sql="UPDATE mycontacts SET userName='$name',userProfile='$path',userEmail='$emails',userMobile=$mobiles,userAddress='$adress',
            updated=now() WHERE userId=$id";
    }
    else
    {   
        $sql="UPDATE mycontacts SET userName='$name',userEmail='$emails',userMobile=$mobiles,userAddress='$adress',
            updated=now() WHERE userId=$id";
    }
    ...
    if ($flag == 1) {
        echo "<script>swal('Contact updated successfully')
        .then((value) =>
        {
    ...
    <div class="container mt-3">
        <h3 class="text-center text-primary mt-3">Update Contact Here</h3>
        <hr>
        ...
        <form class="s-form" action="" method="POST" enctype="multipart/form-data">
            <div class="mb-3 text-center">
                <img src="<?php echo $file ?>" style="height:100px;width:100px;" />
            ...
            ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="userAddress" rows="3"><?php echo $row['userAddress'] ?></textarea>
                    </div>
            <?php
                }
            }
            ...
            <div class="mb3">
                <button class="btn btn-primary" type="submit" name="update">Update Contact</button>
